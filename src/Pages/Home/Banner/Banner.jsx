...
const Banner = () => {
  ...
  <div id="slide1" className="carousel-item relative w-full">
    ...
    <div className="absolute rounded-lg h-full flex items-center  top-0 left-0  bg-gradient-to-r from-[#151515] to-[rgba(21, 21, 21, 0.00)]">
      <div className='space-y-7 ps-12 text-white w-1/3'>
        ...
        <div className='flex'>  
        <button className="btn btn-active btn-primary ms-5">Discover More</button>
